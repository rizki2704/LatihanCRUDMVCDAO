 ...
 */
package edu.rizkirestu.latihanmvcjdbc.controller;

import edu.rizkirestu.latihanmvcjdbc.model.PelangganModel;
import edu.rizkirestu.latihanmvcjdbc.view.PelangganView;
...
public class PelangganController {
    ...
    public void insertPelanggan(PelangganView view){
        ...
        if (nama.trim().equals("")) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(view, new Object[]{"Terjadi error didatabase dengan pesan ", throwable.getMessage()});
            }
        }
    ...
    public void updatePelanggan(PelangganView view){
        if (view.getTablePelanggan().getSelectedRowCount()==0) {
            JOptionPane.showMessageDialog(view, "Pilih Terlebih dahulu data yg akan diubah");
            return;
        }
    ...
    public void deletePelanggan(PelangganView view){
       if (view.getTablePelanggan().getSelectedRowCount()==0) {
            JOptionPane.showMessageDialog(view, "Pilih Terlebih dahulu data yg akan dihapus");
            return;
        } 
